...
<meta charset="utf-8">
<link rel="preload" href="/assets/application_utilities_dark-8dcc68e44dad967a683d18c48f4943a903b3a9ac5cd03bf206d9a3850ba2b4f8.css" as="style" type="text/css">
<link rel="preload" href="/assets/application_dark-9aa15b6b5e3f5c2b4e730fb45a6407d08bf30e8faac40d5b9b797afb45760c10.css" as="style" type="text/css">
...
//<![CDATA[
var gl = window.gl || {};
gl.startup_calls = {"/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md?format=json\u0026viewer=simple":{},"/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md?format=json\u0026viewer=rich":{}};
...
if (gl.startup_graphql_calls && window.fetch) {
  const headers = {"X-CSRF-Token":"tyDZmxV8Bus+gPnD8ygZEJrr8P9EHG6wKQNb5+F91v2ktcKi0aF2kTlbCGaqXjennyu/UoUz1pc8Jex6UrtC3Q==","x-gitlab-feature-category":"source_code_management"};
  const url = `https://git-softeng.polito.it/api/graphql`
...
<script src="/assets/webpack/pages.projects.blob.show.849162ad.chunk.js" defer="defer"></script>
<script>
//<![CDATA[
window.uploads_path = "/se-2022/group-06/EzWh/uploads";
...
<meta name="csrf-token" content="woZxzHUJSNDyb96XrOcGAVZZzL2a3YxCQQvnF3+lwUHRE2r1sdQ4qvW0LzL1kSi2U5mDEFvyNGVULVCKzGNVYQ==" />
<meta name="csp-nonce" />
...
<body class="gl-dark tab-width-8 gl-browser-firefox gl-platform-windows" data-find-file="/se-2022/group-06/EzWh/-/find_file/master" data-group="group-06" data-namespace-id="2529" data-page="projects:blob:show" data-page-type-id="master/ApiTestReport.md" data-project="EzWh" data-project-id="4799">
...
<li><a data-track-action="click_link_new_issue" data-track-label="plus_menu_dropdown" data-qa-selector="new_issue_link" href="/se-2022/group-06/EzWh/-/issues/new">New issue</a></li>
<li><a data-track-action="click_link_new_mr" data-track-label="plus_menu_dropdown" href="/se-2022/group-06/EzWh/-/merge_requests/new">New merge request</a></li>
<li><a data-track-action="click_link_new_snippet_project" data-track-label="plus_menu_dropdown" href="/se-2022/group-06/EzWh/-/snippets/new">New snippet</a></li>
<li class="divider"></li>
<li class="dropdown-bold-header">
GitLab
</li>
...
<input type="hidden" name="group_id" id="group_id" value="2529" class="js-search-group-options" data-group-path="group-06" data-name="Group 6" data-issues-path="/groups/se-2022/group-06/-/issues" data-mr-path="/groups/se-2022/group-06/-/merge_requests" />
<input type="hidden" name="project_id" id="search_project_id" value="4799" class="js-search-project-options" data-project-path="EzWh" data-name="EzWh" data-issues-path="/se-2022/group-06/EzWh/-/issues" data-mr-path="/se-2022/group-06/EzWh/-/merge_requests" data-issues-disabled="false" />
<input type="hidden" name="scope" id="scope" />
<input type="hidden" name="search_code" id="search_code" value="true" />
<input type="hidden" name="snippets" id="snippets" value="false" />
<input type="hidden" name="repository_ref" id="repository_ref" value="master" />
<input type="hidden" name="nav_source" id="nav_source" value="navbar" />
<div class="search-autocomplete-opts hide" data-autocomplete-path="/search/autocomplete" data-autocomplete-project-id="4799" data-autocomplete-project-ref="master"></div>
</form></div>

</li>
<li class="nav-item d-none d-sm-inline-block d-lg-none">
<a title="Search" aria-label="Search" data-toggle="tooltip" data-placement="bottom" data-container="body" href="/search?project_id=4799"><svg class="s16" data-testid="search-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#search"></use></svg>
</a></li>
<li class="user-counter"><a title="Issues" class="dashboard-shortcuts-issues js-prefetch-document" aria-label="Issues" data-qa-selector="issues_shortcut_button" data-toggle="tooltip" data-placement="bottom" data-track-label="main_navigation" data-track-action="click_issues_link" data-track-property="navigation" data-container="body" href="/dashboard/issues?assignee_username=s304907"><svg class="s16" data-testid="issues-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#issues"></use></svg>
<span class="gl-badge badge badge-pill badge-success sm gl-ml-n2  gl-display-none" aria-label="0 assigned issues">0
</span></a></li><li class="user-counter dropdown"><a class="dashboard-shortcuts-merge_requests" title="Merge requests" aria-label="Merge requests" data-qa-selector="merge_requests_shortcut_button" data-toggle="dropdown" data-placement="bottom" data-track-label="main_navigation" data-track-action="click_merge_link" data-track-property="navigation" data-container="body" href="/dashboard/merge_requests?assignee_username=s304907"><svg class="s16" data-testid="git-merge-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#git-merge"></use></svg>
...
<li>
<a class="gl-display-flex! gl-align-items-center js-prefetch-document" href="/dashboard/merge_requests?assignee_username=s304907">Assigned to you
<span class="gl-badge badge badge-pill badge-neutral sm js-assigned-mr-count gl-ml-auto">0
</span></a></li>
<li>
<a class="gl-display-flex! gl-align-items-center js-prefetch-document" href="/dashboard/merge_requests?reviewer_username=s304907">Review requests for you
...
<a class="header-user-dropdown-toggle" data-toggle="dropdown" href="/s304907"><img width="23" height="23" class="header-user-avatar qa-user-avatar lazy" alt="Romantini" data-src="https://secure.gravatar.com/avatar/a5654642c1e03c4295197c5cd16f8e91?s=46&amp;d=identicon" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" />

<svg class="s16 caret-down" data-testid="chevron-down-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#chevron-down"></use></svg>
</a><div class="dropdown-menu dropdown-menu-right">
<ul>
<li class="current-user">
<a class="gl-line-height-20!" data-user="s304907" data-testid="user-profile-link" data-qa-selector="user_profile_link" href="/s304907"><div class="gl-font-weight-bold">
Romantini
</div>
@s304907
...
<li data-track-label="scope_menu" data-container="body" data-placement="right" class="context-header has-tooltip" title="EzWh"><a aria-label="EzWh" class="shortcuts-project rspec-project-link gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Project scope" href="/se-2022/group-06/EzWh"><span class="avatar-container rect-avatar s32 project_avatar">
<span class="avatar avatar-tile s32 identicon bg5">E</span>
</span>
<span class="sidebar-context-title">
EzWh
</span>
</a></li>
<li data-track-label="project_information_menu" class="home"><a aria-label="Project information" class="shortcuts-project-information has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Project information" href="/se-2022/group-06/EzWh/activity"><span class="nav-icon-container">
...
<li data-track-label="activity" class=""><a aria-label="Activity" class="shortcuts-project-activity gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Activity" href="/se-2022/group-06/EzWh/activity"><span>
Activity
</span>
</a></li><li data-track-label="labels" class=""><a aria-label="Labels" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Labels" href="/se-2022/group-06/EzWh/-/labels"><span>
Labels
</span>
</a></li><li data-track-label="hierarchy" class=""><a aria-label="Planning hierarchy" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Planning hierarchy" href="/se-2022/group-06/EzWh/-/planning_hierarchy"><span>
Planning hierarchy
</span>
</a></li><li data-track-label="members" class=""><a aria-label="Members" id="js-onboarding-members-link" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Members" href="/se-2022/group-06/EzWh/-/project_members"><span>
Members
</span>
</a></li>
</ul>

</li><li data-track-label="repository_menu" class="active"><a aria-label="Repository" class="shortcuts-tree has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Repository" href="/se-2022/group-06/EzWh/-/tree/master"><span class="nav-icon-container">
...
<li data-track-label="files" class="active"><a aria-label="Files" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Files" href="/se-2022/group-06/EzWh/-/tree/master"><span>
Files
</span>
</a></li><li data-track-label="commits" class=""><a aria-label="Commits" id="js-onboarding-commits-link" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Commits" href="/se-2022/group-06/EzWh/-/commits/master"><span>
Commits
</span>
</a></li><li data-track-label="branches" class=""><a aria-label="Branches" id="js-onboarding-branches-link" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Branches" href="/se-2022/group-06/EzWh/-/branches"><span>
Branches
</span>
</a></li><li data-track-label="tags" class=""><a aria-label="Tags" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Tags" href="/se-2022/group-06/EzWh/-/tags"><span>
Tags
</span>
</a></li><li data-track-label="contributors" class=""><a aria-label="Contributors" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Contributors" href="/se-2022/group-06/EzWh/-/graphs/master"><span>
Contributors
</span>
</a></li><li data-track-label="graphs" class=""><a aria-label="Graph" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Graph" href="/se-2022/group-06/EzWh/-/network/master"><span>
Graph
</span>
</a></li><li data-track-label="compare" class=""><a aria-label="Compare" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Compare" href="/se-2022/group-06/EzWh/-/compare?from=master&amp;to=master"><span>
Compare
</span>
</a></li>
</ul>

</li><li data-track-label="issues_menu" class=""><a aria-label="Issues" class="shortcuts-issues has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Issues" href="/se-2022/group-06/EzWh/-/issues"><span class="nav-icon-container">
...
<li data-track-label="issue_list" class=""><a aria-label="Issues" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="List" href="/se-2022/group-06/EzWh/-/issues"><span>
List
</span>
</a></li><li data-track-label="boards" class=""><a aria-label="Boards" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Boards" href="/se-2022/group-06/EzWh/-/boards"><span>
Boards
</span>
</a></li><li data-track-label="service_desk" class=""><a aria-label="Service Desk" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Service Desk" href="/se-2022/group-06/EzWh/-/issues/service_desk"><span>
Service Desk
</span>
</a></li><li data-track-label="milestones" class=""><a aria-label="Milestones" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Milestones" href="/se-2022/group-06/EzWh/-/milestones"><span>
Milestones
</span>
</a></li>
</ul>

</li><li data-track-label="merge_requests_menu" class=""><a aria-label="Merge requests" class="shortcuts-merge_requests gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Merge requests" href="/se-2022/group-06/EzWh/-/merge_requests"><span class="nav-icon-container">
...
</li><li data-track-label="ci_cd_menu" class=""><a aria-label="CI/CD" class="shortcuts-pipelines rspec-link-pipelines has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="CI/CD" href="/se-2022/group-06/EzWh/-/pipelines"><span class="nav-icon-container">
...
<li data-track-label="pipelines" class=""><a aria-label="Pipelines" class="shortcuts-pipelines gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Pipelines" href="/se-2022/group-06/EzWh/-/pipelines"><span>
Pipelines
</span>
</a></li><li data-track-label="pipelines_editor" class=""><a aria-label="Editor" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Editor" href="/se-2022/group-06/EzWh/-/ci/editor?branch_name=master"><span>
Editor
</span>
</a></li><li data-track-label="jobs" class=""><a aria-label="Jobs" class="shortcuts-builds gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Jobs" href="/se-2022/group-06/EzWh/-/jobs"><span>
Jobs
</span>
</a></li><li data-track-label="pipeline_schedules" class=""><a aria-label="Schedules" class="shortcuts-builds gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Schedules" href="/se-2022/group-06/EzWh/-/pipeline_schedules"><span>
Schedules
</span>
</a></li>
</ul>

</li><li data-track-label="security_compliance_menu" class=""><a aria-label="Security &amp; Compliance" class="has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Security &amp; Compliance" href="/se-2022/group-06/EzWh/-/security/configuration"><span class="nav-icon-container">
...
<li data-track-label="configuration" class=""><a aria-label="Configuration" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Configuration" href="/se-2022/group-06/EzWh/-/security/configuration"><span>
Configuration
</span>
</a></li>
</ul>

</li><li data-track-label="deployments_menu" class=""><a aria-label="Deployments" class="shortcuts-deployments has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Deployments" href="/se-2022/group-06/EzWh/-/feature_flags"><span class="nav-icon-container">
...
<li data-track-label="feature_flags" class=""><a aria-label="Feature Flags" class="shortcuts-feature-flags gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Feature Flags" href="/se-2022/group-06/EzWh/-/feature_flags"><span>
Feature Flags
</span>
</a></li><li data-track-label="environments" class=""><a aria-label="Environments" class="shortcuts-environments gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Environments" href="/se-2022/group-06/EzWh/-/environments"><span>
Environments
</span>
</a></li><li data-track-label="releases" class=""><a aria-label="Releases" class="shortcuts-deployments-releases gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Releases" href="/se-2022/group-06/EzWh/-/releases"><span>
Releases
</span>
</a></li>
</ul>

</li><li data-track-label="monitor_menu" class=""><a aria-label="Monitor" class="shortcuts-monitor has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Monitor" href="/se-2022/group-06/EzWh/-/metrics"><span class="nav-icon-container">
...
<li data-track-label="metrics" class=""><a aria-label="Metrics" class="shortcuts-metrics gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Metrics" href="/se-2022/group-06/EzWh/-/metrics"><span>
Metrics
</span>
</a></li><li data-track-label="logs" class=""><a aria-label="Logs" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Logs" href="/se-2022/group-06/EzWh/-/logs"><span>
Logs
</span>
</a></li><li data-track-label="error_tracking" class=""><a aria-label="Error Tracking" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Error Tracking" href="/se-2022/group-06/EzWh/-/error_tracking"><span>
Error Tracking
</span>
</a></li><li data-track-label="alert_management" class=""><a aria-label="Alerts" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Alerts" href="/se-2022/group-06/EzWh/-/alert_management"><span>
Alerts
</span>
</a></li><li data-track-label="incidents" class=""><a aria-label="Incidents" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Incidents" href="/se-2022/group-06/EzWh/-/incidents"><span>
Incidents
</span>
</a></li>
</ul>

</li><li data-track-label="infrastructure_menu" class=""><a aria-label="Infrastructure" class="shortcuts-infrastructure has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Infrastructure" href="/se-2022/group-06/EzWh/-/clusters"><span class="nav-icon-container">
...
<li data-track-label="kubernetes" class=""><a aria-label="Kubernetes clusters" class="shortcuts-kubernetes gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Kubernetes clusters" href="/se-2022/group-06/EzWh/-/clusters"><span>
Kubernetes clusters
</span>
</a></li><li data-track-label="serverless" class=""><a aria-label="Serverless platform" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Serverless platform" href="/se-2022/group-06/EzWh/-/serverless/functions"><span>
Serverless platform
</span>
</a></li><li data-track-label="terraform" class=""><a aria-label="Terraform" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Terraform" href="/se-2022/group-06/EzWh/-/terraform"><span>
Terraform
</span>
</a></li>
</ul>

</li><li data-track-label="packages_registries_menu" class=""><a aria-label="Packages &amp; Registries" class="has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Packages &amp; Registries" href="/se-2022/group-06/EzWh/-/packages"><span class="nav-icon-container">
...
<li data-track-label="packages_registry" class=""><a aria-label="Package Registry" class="shortcuts-container-registry gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Package Registry" href="/se-2022/group-06/EzWh/-/packages"><span>
Package Registry
</span>
</a></li><li data-track-label="container_registry" class=""><a aria-label="Container Registry" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Container Registry" href="/se-2022/group-06/EzWh/container_registry"><span>
Container Registry
</span>
</a></li><li data-track-label="infrastructure_registry" class=""><a aria-label="Infrastructure Registry" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Infrastructure Registry" href="/se-2022/group-06/EzWh/-/infrastructure_registry"><span>
Infrastructure Registry
</span>
</a></li>
</ul>

</li><li data-track-label="analytics_menu" class=""><a aria-label="Analytics" class="shortcuts-analytics has-sub-items gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Analytics" href="/se-2022/group-06/EzWh/-/value_stream_analytics"><span class="nav-icon-container">
...
<li data-track-label="cycle_analytics" class=""><a aria-label="Value stream" class="shortcuts-project-cycle-analytics gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Value stream" href="/se-2022/group-06/EzWh/-/value_stream_analytics"><span>
Value stream
</span>
</a></li><li data-track-label="ci_cd_analytics" class=""><a aria-label="CI/CD" class="gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="CI/CD" href="/se-2022/group-06/EzWh/-/pipelines/charts"><span>
CI/CD
</span>
</a></li><li data-track-label="repository_analytics" class=""><a aria-label="Repository" class="shortcuts-repository-charts gl-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Repository" href="/se-2022/group-06/EzWh/-/graphs/master/charts"><span>
Repository
</span>
</a></li>
</ul>

</li><li data-track-label="wiki_menu" class=""><a aria-label="Wiki" class="shortcuts-wiki gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Wiki" href="/se-2022/group-06/EzWh/-/wikis/home"><span class="nav-icon-container">
...
</li><li data-track-label="snippets_menu" class=""><a aria-label="Snippets" class="shortcuts-snippets gl-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Snippets" href="/se-2022/group-06/EzWh/-/snippets"><span class="nav-icon-container">
...
<li class="hidden">
<a aria-label="Activity" class="shortcuts-project-activity gl-link" href="/se-2022/group-06/EzWh/activity">Activity
</a></li>
<li class="hidden">
<a aria-label="Graph" class="shortcuts-network gl-link" href="/se-2022/group-06/EzWh/-/network/master">Graph
</a></li>
<li class="hidden">
<a aria-label="Create a new issue" class="shortcuts-new-issue gl-link" href="/se-2022/group-06/EzWh/-/issues/new">Create a new issue
</a></li>
<li class="hidden">
<a aria-label="Jobs" class="shortcuts-builds gl-link" href="/se-2022/group-06/EzWh/-/jobs">Jobs
</a></li>
<li class="hidden">
<a aria-label="Commits" class="shortcuts-commits gl-link" href="/se-2022/group-06/EzWh/-/commits/master">Commits
</a></li>
<li class="hidden">
<a aria-label="Issue Boards" class="shortcuts-issue-boards gl-link" href="/se-2022/group-06/EzWh/-/boards">Issue Boards
</a></li>
...
<li><a class="group-path breadcrumb-item-text js-breadcrumb-item-text " href="/se-2022">SE 2021-22</a><svg class="s8 breadcrumbs-list-angle" data-testid="angle-right-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#angle-right"></use></svg></li><li><a class="group-path breadcrumb-item-text js-breadcrumb-item-text " href="/se-2022/group-06">Group 6</a><svg class="s8 breadcrumbs-list-angle" data-testid="angle-right-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#angle-right"></use></svg></li> <li><a href="/se-2022/group-06/EzWh"><span class="breadcrumb-item-text js-breadcrumb-item-text">EzWh</span></a><svg class="s8 breadcrumbs-list-angle" data-testid="angle-right-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#angle-right"></use></svg></li>

<li>
<h2 class="breadcrumbs-sub-title" data-qa-selector="breadcrumb_sub_title_content">
<a href="/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md">Repository</a>
</h2>
</li>
</ul>
</div>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"SE 2021-22","item":"https://git-softeng.polito.it/se-2022"},{"@type":"ListItem","position":2,"name":"Group 6","item":"https://git-softeng.polito.it/se-2022/group-06"},{"@type":"ListItem","position":3,"name":"EzWh","item":"https://git-softeng.polito.it/se-2022/group-06/EzWh"},{"@type":"ListItem","position":4,"name":"Repository","item":"https://git-softeng.polito.it/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md"}]}
...
<div class="js-signature-container" data-signatures-path="/se-2022/group-06/EzWh/-/commits/19c8e175001c1895c88c4875b1c684d2c6c7e31c/signatures?limit=1"></div>

<div class="tree-holder" id="tree-holder">
<div class="nav-block">
<div class="tree-ref-container">
<div class="tree-ref-holder">
<form class="project-refs-form" action="/se-2022/group-06/EzWh/-/refs/switch" accept-charset="UTF-8" method="get"><input type="hidden" name="destination" id="destination" value="blob" />
<input type="hidden" name="path" id="path" value="ApiTestReport.md" />
<div class="dropdown">
<button class="dropdown-menu-toggle js-project-refs-dropdown qa-branches-select" type="button" data-toggle="dropdown" data-selected="master" data-ref="master" data-refs-url="/se-2022/group-06/EzWh/refs?sort=updated_desc" data-field-name="ref" data-submit-form-on-click="true" data-visit="true"><span class="dropdown-toggle-text ">master</span><svg class="s16 dropdown-menu-toggle-icon gl-top-3" data-testid="chevron-down-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#chevron-down"></use></svg></button>
...
<a href="/se-2022/group-06/EzWh/-/tree/master">EzWh
</a></li>
<li class="breadcrumb-item">
<a href="/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md"><strong>ApiTestReport.md</strong>
</a></li>
</ul>
</div>
<div class="tree-controls gl-children-ml-sm-3"><a class="gl-button btn btn-default shortcuts-find-file" rel="nofollow" href="/se-2022/group-06/EzWh/-/find_file/master">Find file
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/se-2022/group-06/EzWh/-/blame/master/ApiTestReport.md">Blame</a><a class="gl-button btn btn-default" href="/se-2022/group-06/EzWh/-/commits/master/ApiTestReport.md">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/se-2022/group-06/EzWh/-/blob/1f5fc273224fd4286351d5a11989030332662122/ApiTestReport.md">Permalink</a></div>
</div>

<div class="info-well d-none d-sm-block">
<div class="well-segment">
<ul class="blob-commit-info">
<li class="commit flex-row js-toggle-container" id="commit-19c8e175">
<div class="avatar-cell d-none d-sm-block">
<a href="/d001921"><img alt="Maurizio Morisio&#39;s avatar" src="https://secure.gravatar.com/avatar/853f6310dae27fd9d20e8d76a6b38170?s=80&amp;d=identicon" class="avatar s40 d-none d-sm-inline-block" title="Maurizio Morisio" /></a>
</div>
<div class="commit-detail flex-list">
<div class="commit-content" data-qa-selector="commit_content">
<a class="commit-row-message item-title js-onboarding-commit-item " href="/se-2022/group-06/EzWh/-/commit/19c8e175001c1895c88c4875b1c684d2c6c7e31c">Update ApiTestReport.md</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
19c8e175
</span>
<div class="committer">
<a class="commit-author-link js-user-link" data-user-id="5" href="/d001921">Maurizio Morisio</a> authored <time class="js-timeago" title="May 17, 2022 6:48pm" datetime="2022-05-17T16:48:52Z" data-toggle="tooltip" data-placement="bottom" data-container="body">May 17, 2022</time>
</div>

</div>
<div class="commit-actions flex-row">

<div class="js-commit-pipeline-status" data-endpoint="/se-2022/group-06/EzWh/-/commit/19c8e175001c1895c88c4875b1c684d2c6c7e31c/pipelines?ref=master"></div>
<div class="commit-sha-group btn-group d-none d-sm-flex">
<div class="label label-monospace monospace">
19c8e175
</div>
<button class="btn gl-button btn btn-default btn-icon" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA" data-class="gl-button btn btn-default btn-icon" data-clipboard-text="19c8e175001c1895c88c4875b1c684d2c6c7e31c" type="button" title="Copy commit SHA" aria-label="Copy commit SHA" aria-live="polite"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button>
...
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;ApiTestReport.md&quot;,&quot;gfm&quot;:&quot;`ApiTestReport.md`&quot;}" type="button" title="Copy file path" aria-label="Copy file path" aria-live="polite"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
2.87 KB
</small>
</div>
...
<svg class="s16" data-testid="code-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#code"></use></svg>
...
<svg class="s16" data-testid="doc-text-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#doc-text"></use></svg>
</button></div><a class="btn gl-button btn-confirm js-edit-blob gl-ml-3 " data-track-action="click_edit" data-track-label="edit" href="/se-2022/group-06/EzWh/-/edit/master/ApiTestReport.md">Edit</a><a class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted" data-track-action="click_edit_ide" data-track-label="web_ide" data-track-property="secondary" href="/-/ide/project/se-2022/group-06/EzWh/edit/master/-/ApiTestReport.md">Web IDE</a><div class="btn-group gl-ml-3" role="group">
...
<span class="btn-group has-tooltip js-copy-blob-source-btn-tooltip"><button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-hide-tooltip="true" data-clipboard-target=".blob-content[data-blob-id=&#39;edc06bbb45ea615e508ae641df5a80467ec6654c&#39;] &gt; pre" type="button" title="Copy" aria-label="Copy" aria-live="polite"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button></span>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/se-2022/group-06/EzWh/-/raw/master/ApiTestReport.md"><svg class="s16" data-testid="doc-code-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#doc-code"></use></svg></a>
<a download="ApiTestReport.md" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/se-2022/group-06/EzWh/-/raw/master/ApiTestReport.md?inline=false"><svg class="s16" data-testid="download-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-confirm-secondary" rel="nofollow" data-method="post" href="/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md">Fork</a>
...
<div class="blob-viewer hidden" data-path="ApiTestReport.md" data-type="simple" data-url="/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md?format=json&amp;viewer=simple">
...
<div class="blob-viewer" data-path="ApiTestReport.md" data-rich-type="markup" data-type="rich" data-url="/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md?format=json&amp;viewer=rich">
<div class="text-center gl-mt-4 gl-mb-3">
<span class="gl-spinner gl-spinner-orange gl-spinner-md qa-spinner" aria-label="Loading"></span>
</div>
...
<h3 class="page-title">Delete ApiTestReport.md</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/se-2022/group-06/EzWh/-/blob/master/ApiTestReport.md" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="H+KqKwY4Rg6vKwPPxWKb5zh8UaDa6OhUhvkcOjRaQMQMd7ESwuU2dKjw8mqcFLVQPbweDRvHUHOT36unh5zU5A==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-eb8732a1ff3013a45e8db17b6e104a70">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-eb8732a1ff3013a45e8db17b6e104a70" class="form-control gl-form-input js-commit-message" placeholder="Delete ApiTestReport.md" data-qa-selector="commit_message_field" required="required" rows="3">
Delete ApiTestReport.md</textarea>
</div>
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="branch_name" id="branch_name" value="s304907-master-patch-51724" required="required" class="form-control gl-form-input js-branch-name ref-name" />
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-73b12a12f6852e884e908f726e111647" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-73b12a12f6852e884e908f726e111647">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace ApiTestReport.md</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/se-2022/group-06/EzWh/-/update/master/ApiTestReport.md" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="fsVfWaNLviI37+9XOUQOCwoW/0HUOJf43Yg9GRvN5PVtUERgZ5bOWDA0HvJgMiC8D9aw7BUXL9/IroqEqAtw1Q==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-32374da75a34cc6448e6f221094d4c47">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-32374da75a34cc6448e6f221094d4c47" class="form-control gl-form-input js-commit-message" placeholder="Replace ApiTestReport.md" data-qa-selector="commit_message_field" required="required" rows="3">
Replace ApiTestReport.md</textarea>
</div>
</div>
</div>
...
<label class="col-form-label col-sm-2" for="branch_name">Target Branch</label>
<div class="col-sm-10">
<input type="text" name="branch_name" id="branch_name" value="s304907-master-patch-51726" required="required" class="form-control gl-form-input js-branch-name ref-name" />
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-41ace592e7753126a5db2d95d9fff55d" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-41ace592e7753126a5db2d95d9fff55d">Start a <strong>new merge request</strong> with these changes
</label></div>
...
//<![CDATA[
  window.gl = window.gl || {};
  window.gl.webIDEPath = '/-/ide/project/se-2022/group-06/EzWh/edit/master/-/ApiTestReport.md'
